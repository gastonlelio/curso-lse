...
#define tskTIME_PRIORITY			(tskIDLE_PRIORITY + 1UL)
#define tskPRINT_PRIORITY			(tskIDLE_PRIORITY + 1UL)
...
#define tskTIME_STACK			(configMINIMAL_STACK_SIZE)
#define tskPRINT_STACK			(3 * configMINIMAL_STACK_SIZE)
